...
(* OASIS_START *)
(* DO NOT EDIT (digest: 3cc7d60bf50d60df315ce0632cce6c77) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/c-cube/maki";
          synopsis =
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "enable interface to Yojson";
               ...
               Flag
                 ({
                  ...
                  },
                   {
                      flag_description =
                        Some
                          "build the toy build system on top of maki+oasis-parser";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Library
                 ({
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Maki_yojson"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "maki";
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "src/tools/";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "maki"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "maki_gc.ml"});
               Executable
                 ({
                     cs_name = "maki_display";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "maki_display.ml"});
               Executable
                 ({
                     cs_name = "maki_build";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      bs_build =
                        [
                           (OASISExpr.EBool true, false);
                           (OASISExpr.EFlag "demo_build", true)
                        ];
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "src/demo_build/";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           InternalLibrary "maki";
                           ...
                           FindlibPackage ("oasis-parser", None);
                   ...
                   {exec_custom = false; exec_main_is = "maki_build.ml"});
               Executable
                 ({
                     cs_name = "test_fib";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "test_fib.ml"});
               Doc
                 ({
                     cs_name = "maki";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "*\184\001\154\189^\189\158\209\224sR\215\252\2280";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
